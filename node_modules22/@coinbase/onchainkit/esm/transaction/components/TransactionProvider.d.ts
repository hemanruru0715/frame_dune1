...
export declare function TransactionProvider({ address, capabilities, chainId, children, contracts, onError, onSuccess, }: TransactionProviderReact): import("react/jsx-runtime").JSX.Element;
