 ...
 */
export declare const useName: ({ address, chain }: UseNameOptions, queryOptions?: UseNameQueryOptions) => import("@tanstack/react-query/build/legacy/types").UseQueryResult<GetNameReturnType, Error>;
