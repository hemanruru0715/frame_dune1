...
function IdentityLayout({
  ...
  return /*#__PURE__*/jsxs("div", {
    className: cn(background.default, 'flex items-center space-x-4 px-2 py-1', onClick && `${pressable.default} relative`, className),
