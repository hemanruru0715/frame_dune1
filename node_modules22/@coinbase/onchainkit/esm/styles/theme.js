...
const pressable = {
  default: 'cursor-pointer bg-ock-default active:bg-ock-default-active hover:bg-ock-default-hover',
  alternate: 'cursor-pointer bg-ock-alternate active:bg-ock-alternate-active hover:bg-ock-alternate-hover',
  inverse: 'cursor-pointer bg-ock-inverse active:bg-ock-inverse-active hover:bg-ock-inverse-hover',
  primary: 'cursor-pointer bg-ock-primary active:bg-ock-primary-active hover:bg-ock-primary-hover',
  secondary: 'cursor-pointer bg-ock-secondary active:bg-ock-secondary-active hover:bg-ock-secondary-hover',
...
export { background, cn, color, fill, pressable, text };
