...
exports.getFarcasterChannelsByParticipant = void 0;
var node_1 = require("@airstack/node");
var farcasterChannelsByParticipant_query_1 = require("../graphql/query/farcasterChannelsByParticipant.query");
var iteratePagination_1 = require("../utils/iteratePagination");
var formatFarcasterChannelsByParticipant_1 = require("../utils/formatFarcasterChannelsByParticipant");
/**
 ...
 */
function getFarcasterChannelsByParticipant(input) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function () {
        var _c, fid, actionType, lastActionTimestamp, limit, _d, before, after, variable, _e, data, error, hasPrevPage, hasNextPage, getPrevPage, getNextPage;
        var _this = this;
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    _c = input !== null && input !== void 0 ? input : {}, fid = _c.fid, actionType = _c.actionType, lastActionTimestamp = _c.lastActionTimestamp, limit = _c.limit;
                    _d = lastActionTimestamp !== null && lastActionTimestamp !== void 0 ? lastActionTimestamp : {}, before = _d.before, after = _d.after;
                    variable = {
                    ...
                    return [4 /*yield*/, (0, node_1.fetchQueryWithPagination)(farcasterChannelsByParticipant_query_1.farcasterChannelsByParticipantQuery, variable)];
                case 1:
                    ...
                    return [2 /*return*/, {
                            data: error ? null : (0, formatFarcasterChannelsByParticipant_1.formatFarcasterChannelsByParticipant)(data),
                            error: error,
                            ...
                            getPrevPage: function () { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, (0, iteratePagination_1.iteratePagination)(getPrevPage, formatFarcasterChannelsByParticipant_1.formatFarcasterChannelsByParticipant)];
                            ...
                            getNextPage: function () { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, (0, iteratePagination_1.iteratePagination)(getNextPage, formatFarcasterChannelsByParticipant_1.formatFarcasterChannelsByParticipant)];
                                        case 1: return [2 /*return*/, _a.sent()];
                                    }
                                });
                            }); },
...
exports.getFarcasterChannelsByParticipant = getFarcasterChannelsByParticipant;
//# sourceMappingURL=getFarcasterChannelsByParticipant.js.map