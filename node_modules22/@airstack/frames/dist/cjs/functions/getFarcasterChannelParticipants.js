...
exports.getFarcasterChannelParticipants = void 0;
var node_1 = require("@airstack/node");
var farcasterChannelParticipants_query_1 = require("../graphql/query/farcasterChannelParticipants.query");
var iteratePagination_1 = require("../utils/iteratePagination");
var formatFarcasterChannelParticipants_1 = require("../utils/formatFarcasterChannelParticipants");
/**
 ...
 */
function getFarcasterChannelParticipants(input) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function () {
        var _c, channel, actionType, lastActionTimestamp, limit, _d, before, after, variable, _e, data, error, hasPrevPage, hasNextPage, getPrevPage, getNextPage;
        var _this = this;
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    _c = input !== null && input !== void 0 ? input : {}, channel = _c.channel, actionType = _c.actionType, lastActionTimestamp = _c.lastActionTimestamp, limit = _c.limit;
                    ...
                    return [4 /*yield*/, (0, node_1.fetchQueryWithPagination)(farcasterChannelParticipants_query_1.farcasterChannelParticipantsQuery, variable)];
                case 1:
                    ...
                    return [2 /*return*/, {
                            data: error ? null : (0, formatFarcasterChannelParticipants_1.formatFarcasterChannelParticipants)(data),
                            error: error,
                            ...
                            getPrevPage: function () { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, (0, iteratePagination_1.iteratePagination)(getPrevPage, formatFarcasterChannelParticipants_1.formatFarcasterChannelParticipants)];
                            ...
                            getNextPage: function () { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, (0, iteratePagination_1.iteratePagination)(getNextPage, formatFarcasterChannelParticipants_1.formatFarcasterChannelParticipants)];
                                        case 1: return [2 /*return*/, _a.sent()];
                                    }
                                });
                            }); },
...
exports.getFarcasterChannelParticipants = getFarcasterChannelParticipants;
