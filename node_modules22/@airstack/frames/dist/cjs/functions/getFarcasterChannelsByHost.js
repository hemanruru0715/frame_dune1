...
exports.getFarcasterChannelsByHost = void 0;
var node_1 = require("@airstack/node");
var farcasterChannelsByHost_query_1 = require("../graphql/query/farcasterChannelsByHost.query");
var iteratePagination_1 = require("../utils/iteratePagination");
var formatFarcasterChannelsByHost_1 = require("../utils/formatFarcasterChannelsByHost");
/**
 ...
 */
function getFarcasterChannelsByHost(input) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function () {
        var _c, fid, createdAtTimestamp, limit, _d, before, after, variable, _e, data, error, hasPrevPage, hasNextPage, getPrevPage, getNextPage;
        var _this = this;
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    _c = input !== null && input !== void 0 ? input : {}, fid = _c.fid, createdAtTimestamp = _c.createdAtTimestamp, limit = _c.limit;
                    _d = createdAtTimestamp !== null && createdAtTimestamp !== void 0 ? createdAtTimestamp : {}, before = _d.before, after = _d.after;
                    variable = {
                        host: fid === null || fid === void 0 ? void 0 : fid.toString(),
                    ...
                    return [4 /*yield*/, (0, node_1.fetchQueryWithPagination)(farcasterChannelsByHost_query_1.farcasterChannelsByHostQuery, variable)];
                case 1:
                    ...
                    return [2 /*return*/, {
                            data: error ? null : (0, formatFarcasterChannelsByHost_1.formatFarcasterChannelsByHost)(data),
                            error: error,
                            ...
                            getPrevPage: function () { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, (0, iteratePagination_1.iteratePagination)(getPrevPage, formatFarcasterChannelsByHost_1.formatFarcasterChannelsByHost)];
                            ...
                            getNextPage: function () { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, (0, iteratePagination_1.iteratePagination)(getNextPage, formatFarcasterChannelsByHost_1.formatFarcasterChannelsByHost)];
                                        case 1: return [2 /*return*/, _a.sent()];
                                    }
                                });
                            }); },
...
exports.getFarcasterChannelsByHost = getFarcasterChannelsByHost;
//# sourceMappingURL=getFarcasterChannelsByHost.js.map