...
exports.formatFarcasterUserTokenSentFrom = void 0;
var types_1 = require("../types");
function formatFarcasterUserTokenSentFrom(data) {
    ...
    return __spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray([], ((_b = (_a = ethereum === null || ethereum === void 0 ? void 0 : ethereum.TokenTransfer) === null || _a === void 0 ? void 0 : _a.map(function (_a) {
        var blockchain = _a.blockchain, tokenAddress = _a.tokenAddress, amount = _a.amount, amountInWei = _a.amountInWei, token = _a.token, blockTimestamp = _a.blockTimestamp, blockNumber = _a.blockNumber, txHash = _a.txHash, receiver = _a.receiver, tokenNft = _a.tokenNft, tokenType = _a.tokenType, tokenId = _a.tokenId;
        var nftData = {};
        ...
        return __assign({ blockchain: blockchain, tokenAddress: tokenAddress, amount: amount, amountInWei: amountInWei, name: name, symbol: symbol, blockTimestamp: blockTimestamp, blockNumber: blockNumber, txHash: txHash, tokenType: tokenType, receiver: receiver }, nftData);
        ...
        if (tokenType !== types_1.TokenType.ERC20)
            nftData = __assign(__assign({}, nftData), { metaData: metaData, image: image, tokenId: tokenId });
        return __assign({ blockchain: blockchain, tokenAddress: tokenAddress, amount: amount, amountInWei: amountInWei, name: name, symbol: symbol, blockTimestamp: blockTimestamp, blockNumber: blockNumber, tokenType: tokenType, txHash: txHash, receiver: receiver }, nftData);
...
exports.formatFarcasterUserTokenSentFrom = formatFarcasterUserTokenSentFrom;
