...
exports.validatedCaptchaImageSvg = void 0;
var types_1 = require("../types");
var node_fetch_1 = __importDefault(require("node-fetch"));
var getBase64FrameImage_1 = require("./getBase64FrameImage");
var ValidateCaptchaImg_1 = require("../components/ValidateCaptchaImg");
var validatedCaptchaImageSvg = function (isValidated, options) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, ratio, concertOneFontData;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = (options !== null && options !== void 0 ? options : {}).ratio, ratio = _a === void 0 ? types_1.FrameRatio._1_91__1 : _a;
                return [4 /*yield*/, (0, node_fetch_1.default)("https://bafybeidnrxwduxvffapz6ujromf46xtyn5wkgzehabxe2kvdhdag4zrdeu.ipfs.dweb.link/Roboto-Black.ttf").then(function (res) { return res.arrayBuffer(); })];
            case 1:
                concertOneFontData = _b.sent();
                return [4 /*yield*/, (0, getBase64FrameImage_1.getBase64FrameImage)((0, ValidateCaptchaImg_1.ValidatedCaptchaImg)({ isValidated: isValidated, options: { ratio: ratio } }), {
                        width: ratio === types_1.FrameRatio._1_91__1 ? 1200 : 955,
                        height: ratio === types_1.FrameRatio._1_91__1 ? 630 : 955,
                        fonts: [
                            {
...
exports.validatedCaptchaImageSvg = validatedCaptchaImageSvg;
//# sourceMappingURL=validatedCaptchaImageSvg.js.map