...
exports.allowListFrogMiddleware = void 0;
var __1 = require("../../");
var config_1 = require("../../config");
function allowListFrogMiddleware(parameters) {
    var _this = this;
    var _a = parameters !== null && parameters !== void 0 ? parameters : {}, apiKey = _a.apiKey, env = _a.env;
    ...
    return function (c, next) { return __awaiter(_this, void 0, void 0, function () {
        var fid, body, untrustedData, message, data, isAllowed;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    _a.label = 4;
                case 4: return [4 /*yield*/, (0, __1.createAllowList)(__assign({ fid: fid }, parameters))];
                case 5:
                    isAllowed = (_a.sent()).isAllowed;
...
exports.allowListFrogMiddleware = allowListFrogMiddleware;
