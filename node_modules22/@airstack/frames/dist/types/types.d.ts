...
import { Audience, Exact, FarcasterChannelActionType, InputMaybe, Scalars, TimeFrame, TokenBlockchain, TrendingMintsCriteria, TokenType as AirstackTokenType, TrendingTokensCriteria, Int_Comparator_Exp, FarcasterReactionCriteria } from "./graphql/types";
...
export type FarcasterFollowersOutput = IteratePaginationResponse<FarcasterFollowersOutputData[] | null | undefined>;
...
export type FarcasterFollowingsOutput = IteratePaginationResponse<FarcasterFollowingsOutputData[] | null | undefined>;
...
export type FarcasterUserERC20BalancesOutput = IteratePaginationResponse<(FarcasterUserERC20BalancesOutputData | null)[] | null | undefined>;
...
export type FarcasterUserERC20MintsOutput = IteratePaginationResponse<(FarcasterUserERC20MintsOutputData | null)[] | null | undefined>;
...
export type FarcasterUserNFTBalancesOutput = IteratePaginationResponse<(FarcasterUserNFTBalancesOutputData | null)[] | null | undefined>;
...
export type FarcasterUserNFTMintsOutput = IteratePaginationResponse<(FarcasterUserNFTMintsOutputData | null)[] | null | undefined>;
...
export type FarcasterUserPoapsOutput = IteratePaginationResponse<(FarcasterUserPoapsOutputData | null)[] | null | undefined>;
...
export type SearchFarcastersOutput = IteratePaginationResponse<(SearchFarcastersOutputData | null)[] | null | undefined>;
...
export type FarcasterUserTokenSentFromOutput = IteratePaginationResponse<(FarcasterUserTokenSentFromOutputData | null)[] | null | undefined>;
...
export type FarcasterUserTokenReceivedByOutput = IteratePaginationResponse<(FarcasterUserTokenReceivedByOutputData | null)[] | null | undefined>;
...
export type FarcasterChannelParticipantsOutput = IteratePaginationResponse<FarcasterChannelParticipantsOutputData[] | null | undefined>;
...
export type FarcasterChannelsByParticipantOutput = IteratePaginationResponse<FarcasterChannelsByParticipantOutputData[] | null | undefined>;
...
export type SearchFarcasterChannelsOutput = IteratePaginationResponse<SearchFarcasterChannelsOutputData[] | null | undefined>;
...
export type FarcasterChannelsByHostOutput = IteratePaginationResponse<FarcasterChannelsByHostOutputData[] | null | undefined>;
...
export type GetTrendingMintsOutput = IteratePaginationResponse<GetTrendingMintsOutputData[] | null | undefined>;
export type CreateAllowListQueryVariables = Exact<{
    ...
    baseTokens?: InputMaybe<Array<Scalars["Address"]["input"]> | Scalars["Address"]["input"]>;
    zoraTokens?: InputMaybe<Array<Scalars["Address"]["input"]> | Scalars["Address"]["input"]>;
    goldTokens?: InputMaybe<Array<Scalars["Address"]["input"]> | Scalars["Address"]["input"]>;
    degenTokens?: InputMaybe<Array<Scalars["Address"]["input"]> | Scalars["Address"]["input"]>;
    hamTokens?: InputMaybe<Array<Scalars["Address"]["input"]> | Scalars["Address"]["input"]>;
}>;
...
export interface CreateAllowListInput {
    ...
    isAllowedFunction?: ({ isFollowingUsersOnFarcaster, isFarcasterFollowerCountAbove, }: {
...
export type FarcasterDataVariables = {
    ...
    channels?: Pretty<(FarcasterChannelsByParticipantOutputData | null)[]> | null | undefined;
    followers?: Pretty<(FarcasterFollowersOutputData | null)[]> | null | undefined;
    followings?: Pretty<(FarcasterFollowingsOutputData | null)[]> | null | undefined;
};
...
export type GetTrendingTokensOutput = IteratePaginationResponse<GetTrendingTokensOutputData[] | null | undefined>;
...
export type AllowListMiddlewareParameters = {
    ...
    apiKey?: string;
    allowListCriteria: AllowListCriteria;
    isAllowedFunction?: ({ isPoapsAttended, isFollowingUsersOnFarcaster, isFarcasterFollowerCountAbove, isTokensHold, }: {
        isPoapsAttended?: {
            eventId: number;
            isAttended: boolean;
        }[];
...
export declare enum FrameRatio {
    _1__1 = "1:1",
    _1_91__1 = "1.91:1"
}
...
export type ButtonProps = PostButtonProps | PostRedirectButton | MintButtonProps | LinkButtonProps | TxButtonProps;
...
export type FrameDefinition<TState extends JsonValue | undefined> = {
    ...
    buttons?: [] | [AllowedFrameButtonItems] | [AllowedFrameButtonItems, AllowedFrameButtonItems] | [
...
export type FramesHandlerFunctionReturnType<TState extends JsonValue | undefined> = FrameDefinition<TState> | FrameRedirect;
...
type FramesMiddlewareNextFunction<TState extends JsonValue | undefined, TReturnedContext extends AllowedFramesContextShape> = (context?: TReturnedContext) => FramesMiddlewareReturnType<TState>;
export type FramesMiddlewareReturnType<TState extends JsonValue | undefined> = Promise<FramesHandlerFunctionReturnType<TState> | Response>;
export type FramesMiddleware<TState extends JsonValue | undefined, TReturnedContext extends AllowedFramesContextShape> = (context: FramesContext<TState>, next: FramesMiddlewareNextFunction<TState, TReturnedContext>) => FramesMiddlewareReturnType<TState>;
...
export interface FarcasterDataOutput {
    ...
    farcasterFollowings?: (FarcasterFollowingsOutputData | null)[] | null | undefined;
    farcasterFollowers?: (FarcasterFollowersOutputData | null)[] | null | undefined;
    farcasterChannels?: (FarcasterChannelsByParticipantOutputData | null)[] | null | undefined;
    farcasterCasts?: (FarcasterUserCastsOutputData | null)[] | null | undefined;
}
export declare enum AllowListCriteriaEnum {
    /**
...
export type GetTrendingSwapsOutput = IteratePaginationResponse<GetTrendingSwapsOutputData[] | null | undefined>;
...
export declare enum TrendingSwapsBlockchain {
    /**
     * Base chain (L2)
     */
    Base = "base",
...
export declare enum TrendingSwapsCriteria {
    /**
...
export type FarcasterUserCastsOutput = IteratePaginationResponse<(FarcasterUserCastsOutputData | null)[] | null | undefined>;
...
export type FarcasterChannelFollowersOutput = FarcasterChannelParticipantsOutput;
export interface FarcasterUserRepliesInput {
    fid: number;
    limit?: number;
}
export type FarcasterUserRepliesOutputData = FarcasterUserCastsOutputData;
export type FarcasterUserRepliesOutput = IteratePaginationResponse<(FarcasterUserRepliesOutputData | null)[] | null | undefined>;
...
export type FarcasterUserRecastsOutput = IteratePaginationResponse<(FarcasterUserRepliesOutputData | null)[] | null | undefined>;
...
export type FarcasterUserQuotedRecastsOutput = IteratePaginationResponse<(FarcasterUserRepliesOutputData | null)[] | null | undefined>;
...
export type FarcasterUserLikesOutput = IteratePaginationResponse<(FarcasterUserRepliesOutputData | null)[] | null | undefined>;
