...
export declare enum AccountStandard {
    Erc6551 = "ERC6551"
}
...
export declare enum DomainDappName {
    Ens = "ens"
}
...
export declare enum DomainDappSlug {
    EnsV1 = "ens_v1"
}
...
export declare enum EveryBlockchain {
    All = "ALL"
}
...
export declare enum FarcasterChannelActionType {
    Cast = "cast",
    Follow = "follow",
    Reply = "reply"
}
...
export declare enum FarcasterReactionCriteria {
    Liked = "liked",
    Recasted = "recasted",
    Replied = "replied"
}
...
export declare enum NativeBalanceBlockchain {
    Degen = "degen"
}
...
export declare enum OrderByAsIntString {
    Asc = "ASC",
    Desc = "DESC"
}
...
export declare enum PoapDappName {
    Poap = "poap"
}
...
export declare enum PoapDappSlug {
...
export declare enum PopularDappsCriteria {
    GasSpent = "GAS_SPENT",
...
export declare enum SnapshotBlockchain {
    Base = "base",
    Ethereum = "ethereum",
    Gold = "gold",
    Zora = "zora"
...
export declare enum SocialDappName {
    Farcaster = "farcaster",
    Lens = "lens"
}
...
export declare enum SocialDappSlug {
...
export declare enum TokenBlockchain {
    Base = "base",
    Degen = "degen",
    Ethereum = "ethereum",
    Gold = "gold",
...
export declare enum TrendingBlockchain {
    Base = "base",
    Degen = "degen"
}
...
export declare enum TrendingCastTimeFrame {
    EightHours = "eight_hours",
...
export declare enum TrendingCastsCriteria {
    Likes = "likes",
...
export declare enum TrendingMintsCriteria {
...
export declare enum TrendingTokensCriteria {
...
export declare enum TrendingTokensTransferType {
    All = "all",
...
export type CheckCastReactionsByFarcasterUserQuery = {
    FarcasterReactions: {
        Reaction: Array<{
            cast: {
...
export type CheckChannelActionsByFarcasterUserQuery = {
    FarcasterChannelParticipants: {
        FarcasterChannelParticipant: Array<{
            channelActions: Array<FarcasterChannelActionType> | null;
        }> | null;
    } | null;
};
...
export type FarcasterUserLikesQuery = {
    FarcasterReactions: {
        Reaction: Array<{
            cast: {
                hash: string | null;
...
export type FarcasterUserQuotedRecastsQuery = {
...
export type FarcasterUserRecastsQuery = {
    FarcasterReactions: {
        Reaction: Array<{
            cast: {
                hash: string | null;
...
export type FarcasterUserRepliesQuery = {
    FarcasterReplies: {
        Reply: Array<{
            hash: string | null;
            castedAtTimestamp: any | null;
