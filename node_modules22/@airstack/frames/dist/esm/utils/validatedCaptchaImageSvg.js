...
export const validatedCaptchaImageSvg = async (isValidated, options) => {
    const { ratio = FrameRatio._1_91__1 } = options !== null && options !== void 0 ? options : {};
    const concertOneFontData = await fetch("https://bafybeidnrxwduxvffapz6ujromf46xtyn5wkgzehabxe2kvdhdag4zrdeu.ipfs.dweb.link/Roboto-Black.ttf").then((res) => res.arrayBuffer());
    return await getBase64FrameImage(ValidatedCaptchaImg({ isValidated, options: { ratio } }), {
