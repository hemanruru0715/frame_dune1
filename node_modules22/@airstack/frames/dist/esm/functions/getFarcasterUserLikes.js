 ...
 */
export async function getFarcasterUserLikes(input) {
    ...
    return {
        ...
        hasPrevPage,
        hasNextPage,
        getPrevPage: async () => await iteratePagination(getPrevPage, formatFarcasterUserLikes),
        getNextPage: async () => await iteratePagination(getNextPage, formatFarcasterUserLikes),
    };
}
