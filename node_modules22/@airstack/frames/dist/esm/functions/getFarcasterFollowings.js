 ...
 */
export async function getFarcasterFollowings(input) {
    ...
    return {
        ...
        hasPrevPage,
        hasNextPage,
        getPrevPage: async () => await iteratePagination(getPrevPage, formatFarcasterFollowings),
        getNextPage: async () => await iteratePagination(getNextPage, formatFarcasterFollowings),
    };
}
